...
macro(prepare_package)
  ...
  elseif (APPLE)
    ...
    install(FILES ${PROJECT_SOURCE_DIR}/resources/linux/shrimplay.desktop DESTINATION ${CMAKE_INSTALL_DATAROOTDIR}/applications)
    install(FILES ${PROJECT_SOURCE_DIR}/resources/icon.png DESTINATION ${CMAKE_INSTALL_DATAROOTDIR}/pixmaps RENAME shrimplay.png)
  endif()
endmacro()
...
macro(create_package)
  if(WIN32)
    ...
    set_property(INSTALL "$<TARGET_FILE_NAME:shrimplay>" PROPERTY CPACK_START_MENU_SHORTCUTS "shrimplay")
  elseif (APPLE)
    ...
    set(MACOSX_BUNDLE_GUI_IDENTIFIER "com.zrrg.shrimplay")
    set(MACOSX_BUNDLE_COPYRIGHT "Copyright © 2024 Zrrg. All rights reserved." )
  ...
  elseif(CMAKE_SYSTEM_NAME STREQUAL "Linux")
    ...
    set(CPACK_DEBIAN_PACKAGE_MAINTAINER "Zrrg")
  ...
  set(CPACK_PACKAGE_VENDOR "Zrrg")
  set(CPACK_PACKAGE_INSTALL_DIRECTORY ${CPACK_PACKAGE_NAME})
  set(CPACK_PACKAGE_DESCRIPTION_SUMMARY "A Cross-Platform Desktop Media Player hai hai hai :")
